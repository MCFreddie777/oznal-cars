...
Čo nás však neteší je však, ako sme sa mohli presvedčiť aj fakť že dosť vela hodnôt (33 753) tohto atribútu je nulových (NA). Domnievame sa, že ide o umelo znížené alebo nešpecifikované sumy, práve z dôvodu rankingu v rebríčkoch inzerátov. Preto sme ich (nuly) v úvode, pri načítaní datasetu, nahradili `NA`.
...
```
Rozhodli sme sa dropnúť nad threshold.
...
```
Na grafe môžme vidieť, že skutočne (síce počet dát s zvyšujúcim rokom rastie), z vyšujúcim rokom sa zničuje počet valcov v motoroch.
...
```
Na boxplote môžme vidieť že autá s pohonom na všetky kolesá a s typom paliva diesel majú vyšší počet priemerne najazdených míľ.
